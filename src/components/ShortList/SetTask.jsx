  ...
  return (
    <div className="flex">
      ...
      <div className="w-full">
        <PageHeader name={hr?.hrDetails?.name} desc="Welcome Back!" />
          ...
          <div className="mt-8 mb-8">
            <form action="" onSubmit={handleSubmit}>
              <div className=" flex flex-col">
                ...
                <input
                  value={formData.set1a}
                  name="set1a"
                  onChange={handleChange}
                  placeholder="Question 1"
                  type="text"
                  className="m-1 text-sm h-14 rounded-md font-light border-none outline-none p-3 bg-secondary"
                />
                <input
                  value={formData.set1b}
                  name="set1b"
                  onChange={handleChange}
              ...
              <div className="flex items-center justify-center ">
                <button
                  className="bg-success py-3 px-6 rounded-md text-white flex items-center mt-4"
                  type="submit"
                >
                  Update Task
                </button>
